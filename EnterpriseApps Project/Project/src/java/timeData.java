 ...
 * @author matto
 */
public class timeData extends HttpServlet {
String name;
String time;
...
Statement stat;
       ...
       public void init() throws ServletException {
        ...
        try {
            ...
            stat.execute("CREATE TABLE IF NOT EXISTS time "
                    + "(name CHAR(40), time CHAR(40))");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try ( PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Servlet Time Counter</title>");
                out.println("</head>");
                out.println("<body>");
