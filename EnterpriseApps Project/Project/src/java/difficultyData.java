 ...
 * @author matto
 */
public class difficultyData extends HttpServlet {
String name;
String difficulty;
...
Statement stat;
       ...
       public void init() throws ServletException {
        ...
        try {
            ...
            stat.execute("CREATE TABLE IF NOT EXISTS difficulty "
                    + "(name CHAR(40), difficulty CHAR(40))");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String query = "INSERT INTO difficulty VALUES (?,?)";
            prepStat = (PreparedStatement) conn.prepareStatement(query);
            prepStat.setString(1, name);
            prepStat.setString(2, difficulty);
            ...
            try ( PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Servlet difficulty</title>");
                out.println("</head>");
                out.println("<body>");
